...
printf("Please enter lower corner and upper corner of the window respectively:\n");
scanf("%d %d %d %d", &P1.x, &P1.y, &P2.x, &P2.y);
printf("Please enter the number of points in the polygon to clip:\n");
scanf("%d", &sz);
